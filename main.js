	...
	switch (model.$) {
		case 'Failure':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('I could not load a random mayo for some reason. '),
						A2(
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('p4 col-12 flex items-center justify-center'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('col-6 mxauto')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('flex justify-center items-end mb3')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('m0 p0'),
												A2($elm$html$Html$Attributes$style, 'font-size', '48px'),
												A2($elm$html$Html$Attributes$style, 'height', '46px')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('MOAR CLOWNZ')
											])),
										A2(
										$elm$html$Html$button,
										_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('p1')
			]),
		_List_fromArray(
			[
